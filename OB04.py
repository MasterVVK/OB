...
# одного из пяти SOLID принципов объектно-ориентированного программирования. Принцип гласит, что программные сущности (классы, модули, функции и т.д.) должны быть открыты для расширения, но закрыты для модификации.
#
...
# Бой 1
battle(fighter_with_sword, monster)

# Смена оружия на лук
fighter_with_sword.change_weapon(Bow())

# Бой 2
new_monster = Monster()
battle(fighter_with_sword, new_monster)
